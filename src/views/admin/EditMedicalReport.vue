            ...
            <form @submit.prevent="submit" class="medical-form">
                  ...
                  <div class="form-field">
                    ...
                    <div class="patient-info">
                      ...
                      <div class="patient-details">
                        ...
                        <span class="patient-id">ID: #{{ store.currentReport?.patient_id }}</span>
                      </div>
                    </div>
                  </div>
                  <div class="form-field">
                    ...
                    <div class="doctor-info">
                      ...
                      <div class="doctor-details">
                        ...
                        <span class="doctor-specialty">{{ store.currentReport?.report_type }}</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="action-btn primary" :disabled="loading">
                  <Save :size="16" />
                  {{ loading ? 'Mise à jour en cours...' : 'Mettre à jour le rapport' }}
                </button>
              </div>
            </form>
          </div>
