      ...
      <main class="admin-main">
        <div class="dashboard-admin">
              ...
              <div class="title-section">
                <div class="title-content">
                  ...
                  <p class="dashboard-subtitle">
                    Mettez à jour les informations du technicien de laboratoire
                  </p>
                </div>
              </div>
          ...
          <div v-else-if="labTechnicianStore.error || departmentStore.error || laboratoryStore.error" class="error-state">
            ...
            <div v-if="labTechnicianStore.error">
              <p>Erreur du technicien: <strong>{{ labTechnicianStore.error }}</strong></p>
              <ul v-if="labTechnicianStore.error.message">
                <li>{{ labTechnicianStore.error.message }}</li>
              </ul>
              <ul v-if="labTechnicianStore.error.lab_technician_id">
          ...
          <!-- Success State -->
          <div v-else-if="labTechnicianStore.success" class="success-state">
            <div class="success-icon">
              <CheckCircle :size="48" />
            </div>
            <p>{{ labTechnicianStore.success }}</p>
          </div>

          <!-- Form Section -->
          <div class="form-section" v-if="!labTechnicianStore.loading && labTechnicianStore.currentTechnician && !labTechnicianStore.error && !departmentStore.error && !laboratoryStore.error">
            <form @submit.prevent="submitForm" enctype="multipart/form-data" class="lab-tech-form">
        ...
        <!-- Form Groups -->
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="form-field">
                    <label>Prénom</label>
                    <input v-model="form.first_name" type="text" placeholder="Prénom" class="form-input" />
                    <span v-if="validationErrors.first_name" class="error-message">{{ validationErrors.first_name[0] }}</span>
                  </div>
                  <div class="form-field">
                    <label>Nom</label>
                    <input v-model="form.last_name" type="text" placeholder="Nom" class="form-input" />
                ...
                <div class="form-row">
                  ...
                  <div class="form-field password-field">
                    ...
                    <input v-model="form.password" type="password" placeholder="Laisser vide pour ne pas changer" class="form-input" />
                ...
                <div class="form-row">
                  ...
                  <div class="form-field">
                    ...
                    <span v-if="validationErrors.country" class="error-message">{{ validationErrors.country[0] }}</span>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="form-field">
                    ...
                    <input v-model="form.speciality" type="text" placeholder="Spécialité" class="form-input" />
                    <span v-if="validationErrors.speciality" class="error-message">{{ validationErrors.speciality[0] }}</span>
                  </div>
                  <div class="form-field">
                    <label>Qualification</label>
                    <input v-model="form.qualification" type="text" placeholder="Qualification" class="form-input" />
                ...
                <div class="form-row">
                  <div class="form-field">
                    ...
                    <select v-model="form.laboratory_id" class="form-select">
                      <option value="" disabled>-- Sélectionner --</option>
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="action-btn primary" :disabled="labTechnicianStore.loading">
                  <Save :size="16" />
                  {{ labTechnicianStore.loading ? 'Mise à jour...' : 'Mettre à jour' }}
                </button>
              </div>
            </form>
          </div>
