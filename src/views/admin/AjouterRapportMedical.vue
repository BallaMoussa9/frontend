              ...
              <div class="title-section">
                <div class="title-content">
                  ...
                  <p class="dashboard-subtitle">
                    Créez un nouveau rapport médical pour un patient
                  </p>
                </div>
              </div>
            ...
            <form @submit.prevent="submit" class="medical-form">
              ...
              <div class="form-group">
                ...
                <div class="form-field full-width">
                  ...
                  <select v-model="form.report_type" class="form-select large-field" required>
              ...
              <div class="form-group">
                ...
                <div class="form-field full-width">
                  ...
                  <select v-model="form.patient_id" class="form-select large-field" required>
              ...
              <div class="form-group">
                ...
                <div class="form-field full-width">
                  ...
                  <input v-model="form.title" type="text" placeholder="Entrez le titre du rapport" class="form-input" required />
                </div>

                <div class="form-field full-width margin-top-field">
                  <label>Contenu détaillé</label>
                  <textarea v-model="form.content" placeholder="Décrivez en détail le contenu du rapport..." class="form-textarea" rows="8" required></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="form-field">
                    ...
                    <select v-model="form.doctor_id" class="form-select large-field">
                  ...
                  <div class="form-field">
                    ...
                    <select v-model="form.priority" class="form-select large-field">
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="action-btn primary" :disabled="loading">
                  <Save :size="16" />
                  {{ loading ? 'Ajout en cours...' : 'Ajouter le rapport' }}
                </button>
              </div>
            </form>
          </div>
...
const submit = async () => {
  ...
  try {
    ...
    router.push({ name: 'GererRapports' })
  } catch (error) {
    console.error("Erreur lors de l'ajout du rapport:", error)
    alert("Une erreur est survenue lors de l'ajout du rapport médical.")
  } finally {
    loading.value = false
  }
}
