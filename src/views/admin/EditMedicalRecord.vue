            ...
            <form @submit.prevent="submit" class="medical-form">
              ...
              <div class="form-group">
                ...
                <div class="form-field full-width">
                  ...
                  <input v-model="form.diagnosis" type="text" placeholder="Diagnostic principal..." class="form-input" required />
                </div>

                <div class="form-field full-width margin-top-field">
                  <label>Plan de traitement</label>
                  <input v-model="form.treatment_plan" type="text" placeholder="Médicaments, doses, durée..." class="form-input" />
                </div>

                <div class="form-field full-width margin-top-field">
                  <label>Maladies chroniques</label>
                  <textarea v-model="form.chronic_conditions" placeholder="Détaillez les antécédents médicaux..." class="form-textarea" rows="4"></textarea>
                </div>
              </div>
...
const submit = async () => {
  loading.value = true
  try {
    await axios.put(`http://localhost/api/dossiers-medicaux/${route.params.id}`, form)
