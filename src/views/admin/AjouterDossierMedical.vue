      ...
      <main class="admin-main">
        <div class="dashboard-admin">
          ...
          <div class="form-section" v-if="!loading">
            <form @submit.prevent="submit" class="medical-form">
              <!-- Patient Selection -->
              <div class="form-group">
                ...
                <div class="form-field full-width">
                  ...
                  <select v-model="nouveauRapport.patient" class="form-select large-field" required>
              ...
              <div class="form-group">
                ...
                <div class="form-row">
                  <div class="form-field">
                    ...
                    <select v-model="form.blood_type" class="form-select large-field">
                  ...
                  <div class="form-field">
                    <label>Statut</label>
                    <select v-model="form.status" class="form-select large-field">
                      <option value="">-- Sélectionner --</option>
              ...
              <div class="form-group">
                ...
                <div class="form-field full-width">
                  ...
                  <textarea v-model="form.diagnosis" placeholder="Entrez le diagnostic du patient" class="form-textarea" rows="4"></textarea>
                </div>

                <div class="form-field full-width margin-top-field">
                  <label>Plan de traitement</label>
                  <textarea v-model="form.treatment_plan" placeholder="Décrivez le plan de traitement prévu" class="form-textarea" rows="4"></textarea>
                </div>

                <div class="form-field full-width margin-top-field">
                  <label>Maladies chroniques</label>
                  <textarea v-model="form.chronic_conditions" placeholder="Listez les maladies chroniques si applicable" class="form-textarea" rows="3"></textarea>
                </div>
              </div>
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="action-btn primary" :disabled="loading">
                  <Save :size="16" />
                  {{ loading ? 'Ajout en cours...' : 'Ajouter le dossier' }}
                </button>
              </div>
            </form>
          </div>
...
const submit = async () => {
  ...
  try {
    ...
    router.push({ name: 'GererDossiers' })
  } catch (error) {
    console.error('Erreur lors de l\'ajout du dossier:', error)
    alert('Une erreur est survenue lors de l\'ajout du dossier médical.')
  } finally {
    loading.value = false
  }
}
...
/* Marges supplémentaires pour les textarea spécifiques */
.form-field.margin-top-field {
  margin-top: 2rem;
}
